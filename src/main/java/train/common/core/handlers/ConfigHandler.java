...
public class ConfigHandler {
	...
	public static void init(File configFile) {
		...
		try {
			...
			DISABLE_NEI_RECIPES = cf.get(CATEGORY_GENERAL, "DISABLE_NEI_RECIPES", false, "disables our system of registering recipes with NEI, there are a number of issues registering our recipes with NEI, enable at your own risk").getBoolean(true);
