...
import train.common.blocks.switchStand.BlockAutoSwitchStand;

import java.util.Random;

public class TileAutoSwitchStand extends TileSwitch {

    public TileAutoSwitchStand(){}
    public TileAutoSwitchStand(BlockAutoSwitchStand block){
        host = block;
    }
