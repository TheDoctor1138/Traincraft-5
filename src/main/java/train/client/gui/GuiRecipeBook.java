        ...
        addPage("Welcome to the Traincraft guide! \nThis book contains everything you need to know about Traincraft.\n\nAuthors:\nSpitfire4466,\nMrbrutal\n\nBukkit port: \nDV8FromTheWorld\n\nThanks to CovertJaguar for his help and a great API.\n", "", "left", new ArrayList<StackToDraw>() {
            {
                ...
                add(new StackToDraw(new ItemStack(EntityPassengerCar1.thisItem), 140, 175));
        ...
        addPage("Modelers:\nDAYdiecast,\nhelldiver,\nBlockStormTwo,\nChandlerBingUA.\n\nGitHub 1.7.10 port Team: \nEternal BlueFlame,\nNitroxydeX,\nFirEmerald,\nHagurd\n \nWebsite:\nhttps://traincraft.org", "", "right", new ArrayList<StackToDraw>() {
            {
                ...
                add(new StackToDraw(new ItemStack(EntityPassengerCar1.thisItem), 40, 175));
                add(new StackToDraw(new ItemStack(EntityPassengerCar1.thisItem), 60, 175));
