...
public class ItemRenderowoSwitchStand implements IItemRenderer {
    private static final ModelowoSwitchStandOff modeSwitch = new ModelowoSwitchStandOff();
    ...
    public ItemRenderowoSwitchStand() {
    }
