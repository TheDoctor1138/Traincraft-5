...
public class ItemRenderowoYardSwitchStand implements IItemRenderer {
    private static final ModelowoYardSwitchStandOff modeSwitch = new ModelowoYardSwitchStandOff();
    ...
    public ItemRenderowoYardSwitchStand() {
    }
